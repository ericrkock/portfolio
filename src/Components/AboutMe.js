            ...
            <div className="about-me-wrapper">
                <div className="about-me">
                    ...
                    <div className="bio-me">
                        ...
                        <div className="icons">
                            <a className="icon-pos" href="https://www.linkedin.com/in/ericrkock/" target="_blank" rel="noopener noreferrer" >
                                <FontAwesomeIcon icon={faLinkedin} size="2x" color="#fff" /></a>
                            <a className="icon-pos" href="https://www.freecodecamp.org/eric-r-kock" target="_blank" rel="noopener noreferrer" >
                                <FontAwesomeIcon icon={faFreeCodeCamp} size="2x" color="#fff" /></a>
                            <a href="https://github.com/ericrkock" target="_blank" rel="noopener noreferrer" >
